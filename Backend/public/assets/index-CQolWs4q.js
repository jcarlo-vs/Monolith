...
function zi(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    _r(e, n), xa(n, t, r), Eu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
hs = _o;
ys = zn;
var Pd = { usingClientEntryPoint: !1, Events: [Gt, jn, ul, ms, vs, _o] },
  vt = {
...
function Ld() {
  ...
  return zr.jsx("div", {
    children: zr.jsx("button", { onClick: t, children: e ? `${e}` : "OPEN" }),
  });
}
ec(document.getElementById("root")).render(
  zr.jsx(el.StrictMode, { children: zr.jsx(Ld, {}) })
);
